    ...
    if args.sample:
        sample(
            ...
            **raw_config['diffusion_params'],
            ...
            use_risk_variable=raw_config.get('risk_conditioning', False),
            y_conditional=raw_config['sample'].get('y_conditional', None),
            y_cond_weights=raw_config['sample'].get('y_cond_weights', None),
            y_range=raw_config['sample'].get('y_range', False),
